...
void send_gratuitous_arp(const int ifIndex, const char *devname, const char *sipaddress, const char *tipaddress, const char *src_mac_address, const char *dst_mac_address){
  int rawfd;
  ...
  *((int *)&(arpbody.arp_spa[0])) = inet_addr(sipaddress); //arpbody.arp_spa
  *((int *)&(arpbody.arp_tpa[0])) = inet_addr(tipaddress); //arpbody.arp_tpa
...
int main(int argc, char **argv){
  int ifindex = 0;
  char *devname = "eth2";
  char *sipaddr = "192.168.100.3";
  char *tipaddr = "192.168.100.200";
  char *src_macaddr = "08:00:27:00:c8:29";
  char *dst_macaddr = "08:00:27:66:00:06";
  struct ifreq ifreq;
  ...
  send_gratuitous_arp(ifindex, devname, sipaddr, tipaddr, src_macaddr, dst_macaddr);
  return 0;
